...
test "Timer" {
    ...
    warn("Running loops\n");
    loops(timerRead, "timer.read()"[0..], loop_count, inner_loop_count, true);
    loops(readTsc, "rdstc()"[0..], loop_count, inner_loop_count, true);
    loops(rdtscp, "rdstcp()"[0..], loop_count, inner_loop_count, true);
    loops(readCc, "readCc()"[0..], loop_count, inner_loop_count, true);
}
